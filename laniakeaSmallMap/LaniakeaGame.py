...
class LaniakeaGame(Game):
    ...
    def getActionSize(self):
        ...
        """
        # 8*6 Board, 4 Directions, 8 possible moves from home area, 10 possible inserts, 2 rotations
        return ACTION_SIZE 
    ...
    def getNextState(self, board, player, action):
        ...
        if action == -1:
            ...
            if(len(insert_rows) > 0):
                ...
                insert_row = 10 # setze 10 falls nicht da
    ...
    def getValidMoves(self, board, player):
        ...
        for move in valid_moves:
            ...
            if len(insert_rows) == 0:
                index = encode_action((from_pos, to_pos), 10)
    ...
    def display( board):
        ...
        board_str = ""
        board_str += f"Home W: {board[0, 5]}, Home B: {board[1, 5]}, Scored W: {board[2, 5]}, Scored B: {board[3, 5]}\n"
