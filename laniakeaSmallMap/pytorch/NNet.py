...
from laniakeaSmallMap.LaniakeaHelper import decode_action, mirror_action

sys.path.append("../../")
from laniakeaSmallMap.LaniakeaBoardConverter import board_to_tensor
...
class NNetWrapper(NeuralNet):
    ...
    * Expects *volumetric* game boards with shape ``(x, y, z)``.
    ...
    def board_to_tensor(self, board, player):
        """Convert a board to a tensor representation."""
